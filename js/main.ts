...
class weatherInformation {
    ...
    constructor(city: string, temperature: string, description:string, humidity:string,windSpeed:string, icon:any) {
        this.city = city;
...
var processResults = function (temperatureInfo) {
    console.log(this);
    let data = new weatherInformation(
        temperatureInfo.name,
        temperatureInfo.main.temp,
        temperatureInfo.weather[0].main,
        temperatureInfo.main.humidity,
        temperatureInfo.wind.speed,
        temperatureInfo.weather[0].icon
        );
